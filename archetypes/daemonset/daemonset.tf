    ...
    template {
      ...
      spec {
        ...
        dynamic "ephemeral_containers" {
          for_each = lookup(local.k8s_apps_v1_daemon_set_parameters, "ephemeral_containers", [])
          content {
        ...
        overhead            = lookup(local.k8s_apps_v1_daemon_set_parameters, "overhead", null)
        preemption_policy   = lookup(local.k8s_apps_v1_daemon_set_parameters, "preemption_policy", null)
        ...
        set_hostname_asfqdn              = lookup(local.k8s_apps_v1_daemon_set_parameters, "set_hostname_asfqdn", null)
        ...
        dynamic "topology_spread_constraints" {
          for_each = lookup(local.k8s_apps_v1_daemon_set_parameters, "topology_spread_constraints", [])
          content {
            dynamic "label_selector" {
