...
resource "k8s_apps_v1_deployment" "this" {
  ...
  spec {
    min_ready_seconds         = lookup(local.k8s_apps_v1_deployment_parameters, "min_ready_seconds", null)
    paused                    = lookup(local.k8s_apps_v1_deployment_parameters, "paused", null)
    progress_deadline_seconds = lookup(local.k8s_apps_v1_deployment_parameters, "progress_deadline_seconds", null)
    replicas                  = lookup(local.k8s_apps_v1_deployment_parameters, "replicas", null)
    revision_history_limit    = lookup(local.k8s_apps_v1_deployment_parameters, "revision_history_limit", null)

    dynamic "selector" {
      for_each = lookup(local.k8s_apps_v1_deployment_parameters, "selector", null) == null ? [] : [local.k8s_apps_v1_deployment_parameters.selector]
      content {
    ...
    dynamic "strategy" {
      for_each = lookup(local.k8s_apps_v1_deployment_parameters, "strategy", null) == null ? [] : [local.k8s_apps_v1_deployment_parameters.strategy]
      content {
        dynamic "rolling_update" {
          for_each = lookup(strategy.value, "rolling_update", null) == null ? [] : [strategy.value.rolling_update]
          content {
    ...
    template {
      ...
      spec {
        active_deadline_seconds = lookup(local.k8s_apps_v1_deployment_parameters, "active_deadline_seconds", null)

        dynamic "affinity" {
          for_each = lookup(local.k8s_apps_v1_deployment_parameters, "affinity", null) == null ? [] : [local.k8s_apps_v1_deployment_parameters.affinity]
          content {
        ...
        automount_service_account_token = lookup(local.k8s_apps_v1_deployment_parameters, "automount_service_account_token", null)

        dynamic "containers" {
          for_each = lookup(local.k8s_apps_v1_deployment_parameters, "containers", [])
          content {
        ...
        dynamic "dns_config" {
          for_each = lookup(local.k8s_apps_v1_deployment_parameters, "dns_config", null) == null ? [] : [local.k8s_apps_v1_deployment_parameters.dns_config]
          content {
        ...
        host_ipc     = lookup(local.k8s_apps_v1_deployment_parameters, "host_ipc", null)
        host_network = lookup(local.k8s_apps_v1_deployment_parameters, "host_network", null)
        host_pid     = lookup(local.k8s_apps_v1_deployment_parameters, "host_pid", null)
        hostname     = lookup(local.k8s_apps_v1_deployment_parameters, "hostname", null)

        dynamic "image_pull_secrets" {
          for_each = lookup(local.k8s_apps_v1_deployment_parameters, "image_pull_secrets", [])
          content {
        ...
        dynamic "init_containers" {
          for_each = lookup(local.k8s_apps_v1_deployment_parameters, "init_containers", [])
          content {
        ...
        dynamic "readiness_gates" {
          for_each = lookup(local.k8s_apps_v1_deployment_parameters, "readiness_gates", [])
          content {
            condition_type = readiness_gates.value.condition_type
          }
        }
        restart_policy     = lookup(local.k8s_apps_v1_deployment_parameters, "restart_policy", null)
        runtime_class_name = lookup(local.k8s_apps_v1_deployment_parameters, "runtime_class_name", null)
        scheduler_name     = lookup(local.k8s_apps_v1_deployment_parameters, "scheduler_name", null)
        ...
        dynamic "tolerations" {
          for_each = lookup(local.k8s_apps_v1_deployment_parameters, "tolerations", [])
          content {
        ...
        dynamic "volumes" {
          for_each = lookup(local.k8s_apps_v1_deployment_parameters, "volumes", [])
          content {
