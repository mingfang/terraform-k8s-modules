//GENERATE DYNAMIC//k8s_batch_v1_job////
resource "k8s_batch_v1_job" "this" {


  metadata {
    annotations = lookup(local.k8s_batch_v1_job_parameters, "annotations", null)
    labels      = lookup(local.k8s_batch_v1_job_parameters, "labels", null)
    name        = lookup(local.k8s_batch_v1_job_parameters, "name", null)
    namespace   = lookup(local.k8s_batch_v1_job_parameters, "namespace", null)
  }
  ...
  spec {
    ...
    dynamic "selector" {
      for_each = lookup(local.k8s_batch_v1_job_parameters, "selector", null) == null ? [] : [local.k8s_batch_v1_job_parameters.selector]
      content {
    ...
    template {
      ...
      spec {
        ...
        dynamic "affinity" {
          for_each = lookup(local.k8s_batch_v1_job_parameters, "affinity", null) == null ? [] : [local.k8s_batch_v1_job_parameters.affinity]
          content {
        ...
        automount_service_account_token = lookup(local.k8s_batch_v1_job_parameters, "automount_service_account_token", null)

        dynamic "containers" {
          for_each = lookup(local.k8s_batch_v1_job_parameters, "containers", [])
          content {
        ...
        dynamic "dns_config" {
          for_each = lookup(local.k8s_batch_v1_job_parameters, "dns_config", null) == null ? [] : [local.k8s_batch_v1_job_parameters.dns_config]
          content {
        ...
        dns_policy           = lookup(local.k8s_batch_v1_job_parameters, "dns_policy", null)
        enable_service_links = lookup(local.k8s_batch_v1_job_parameters, "enable_service_links", null)

        dynamic "ephemeral_containers" {
          for_each = lookup(local.k8s_batch_v1_job_parameters, "ephemeral_containers", [])
          content {
        ...
        dynamic "host_aliases" {
          for_each = lookup(local.k8s_batch_v1_job_parameters, "host_aliases", [])
          content {
        ...
        host_ipc     = lookup(local.k8s_batch_v1_job_parameters, "host_ipc", null)
        host_network = lookup(local.k8s_batch_v1_job_parameters, "host_network", null)
        host_pid     = lookup(local.k8s_batch_v1_job_parameters, "host_pid", null)
        hostname     = lookup(local.k8s_batch_v1_job_parameters, "hostname", null)

        dynamic "image_pull_secrets" {
          for_each = lookup(local.k8s_batch_v1_job_parameters, "image_pull_secrets", [])
          content {
        ...
        dynamic "init_containers" {
          for_each = lookup(local.k8s_batch_v1_job_parameters, "init_containers", [])
          content {
...
*/
        ...
        node_name           = lookup(local.k8s_batch_v1_job_parameters, "node_name", null)
        node_selector       = lookup(local.k8s_batch_v1_job_parameters, "node_selector", null)
        overhead            = lookup(local.k8s_batch_v1_job_parameters, "overhead", null)
        preemption_policy   = lookup(local.k8s_batch_v1_job_parameters, "preemption_policy", null)
        priority            = lookup(local.k8s_batch_v1_job_parameters, "priority", null)
        priority_class_name = lookup(local.k8s_batch_v1_job_parameters, "priority_class_name", null)

        dynamic "readiness_gates" {
          for_each = lookup(local.k8s_batch_v1_job_parameters, "readiness_gates", [])
          content {
            condition_type = readiness_gates.value.condition_type
          }
        }
        restart_policy     = lookup(local.k8s_batch_v1_job_parameters, "restart_policy", null)
        runtime_class_name = lookup(local.k8s_batch_v1_job_parameters, "runtime_class_name", null)
        scheduler_name     = lookup(local.k8s_batch_v1_job_parameters, "scheduler_name", null)

        dynamic "security_context" {
          for_each = lookup(local.k8s_batch_v1_job_parameters, "security_context", null) == null ? [] : [local.k8s_batch_v1_job_parameters.security_context]
          content {
        ...
        dynamic "tolerations" {
          for_each = lookup(local.k8s_batch_v1_job_parameters, "tolerations", [])
          content {
        ...
        dynamic "topology_spread_constraints" {
          for_each = lookup(local.k8s_batch_v1_job_parameters, "topology_spread_constraints", [])
          content {
            dynamic "label_selector" {
        ...
        dynamic "volumes" {
          for_each = lookup(local.k8s_batch_v1_job_parameters, "volumes", [])
          content {
    ...
    ttl_seconds_after_finished = lookup(local.k8s_batch_v1_job_parameters, "ttl_seconds_after_finished", null)
  }
