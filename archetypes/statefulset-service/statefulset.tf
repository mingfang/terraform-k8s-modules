...
resource "k8s_apps_v1_stateful_set" "this" {
  ...
  spec {
    pod_management_policy  = lookup(local.k8s_apps_v1_stateful_set_parameters, "pod_management_policy", null)
    replicas               = lookup(local.k8s_apps_v1_stateful_set_parameters, "replicas", null)
    revision_history_limit = lookup(local.k8s_apps_v1_stateful_set_parameters, "revision_history_limit", null)

    dynamic "selector" {
      for_each = lookup(local.k8s_apps_v1_stateful_set_parameters, "selector", null) == null ? [] : [local.k8s_apps_v1_stateful_set_parameters.selector]
      content {
    ...
    service_name = local.k8s_apps_v1_stateful_set_parameters.service_name
    ...
    template {
      ...
      spec {
        active_deadline_seconds = lookup(local.k8s_apps_v1_stateful_set_parameters, "active_deadline_seconds", null)

        dynamic "affinity" {
          for_each = lookup(local.k8s_apps_v1_stateful_set_parameters, "affinity", null) == null ? [] : [local.k8s_apps_v1_stateful_set_parameters.affinity]
          content {
        ...
        automount_service_account_token = lookup(local.k8s_apps_v1_stateful_set_parameters, "automount_service_account_token", null)
        ...
        enable_service_links = lookup(local.k8s_apps_v1_stateful_set_parameters, "enable_service_links", null)

        dynamic "ephemeral_containers" {
          for_each = lookup(local.k8s_apps_v1_stateful_set_parameters, "ephemeral_containers", [])
          content {
        ...
        host_ipc     = lookup(local.k8s_apps_v1_stateful_set_parameters, "host_ipc", null)
        host_network = lookup(local.k8s_apps_v1_stateful_set_parameters, "host_network", null)
        host_pid     = lookup(local.k8s_apps_v1_stateful_set_parameters, "host_pid", null)
        hostname     = lookup(local.k8s_apps_v1_stateful_set_parameters, "hostname", null)

        dynamic "image_pull_secrets" {
          for_each = lookup(local.k8s_apps_v1_stateful_set_parameters, "image_pull_secrets", [])
          content {
        ...
        node_name           = lookup(local.k8s_apps_v1_stateful_set_parameters, "node_name", null)
        node_selector       = lookup(local.k8s_apps_v1_stateful_set_parameters, "node_selector", null)
        overhead            = lookup(local.k8s_apps_v1_stateful_set_parameters, "overhead", null)
        preemption_policy   = lookup(local.k8s_apps_v1_stateful_set_parameters, "preemption_policy", null)
        priority            = lookup(local.k8s_apps_v1_stateful_set_parameters, "priority", null)
        priority_class_name = lookup(local.k8s_apps_v1_stateful_set_parameters, "priority_class_name", null)

        dynamic "readiness_gates" {
          for_each = lookup(local.k8s_apps_v1_stateful_set_parameters, "readiness_gates", [])
          content {
            condition_type = readiness_gates.value.condition_type
          }
        }
        restart_policy     = lookup(local.k8s_apps_v1_stateful_set_parameters, "restart_policy", null)
        runtime_class_name = lookup(local.k8s_apps_v1_stateful_set_parameters, "runtime_class_name", null)
        scheduler_name     = lookup(local.k8s_apps_v1_stateful_set_parameters, "scheduler_name", null)

        dynamic "security_context" {
          for_each = lookup(local.k8s_apps_v1_stateful_set_parameters, "security_context", null) == null ? [] : [local.k8s_apps_v1_stateful_set_parameters.security_context]
          content {
        ...
        service_account                  = lookup(local.k8s_apps_v1_stateful_set_parameters, "service_account", null)
        service_account_name             = lookup(local.k8s_apps_v1_stateful_set_parameters, "service_account_name", null)
        set_hostname_asfqdn              = lookup(local.k8s_apps_v1_stateful_set_parameters, "set_hostname_asfqdn", null)
        share_process_namespace          = lookup(local.k8s_apps_v1_stateful_set_parameters, "share_process_namespace", null)
        subdomain                        = lookup(local.k8s_apps_v1_stateful_set_parameters, "subdomain", null)
        termination_grace_period_seconds = lookup(local.k8s_apps_v1_stateful_set_parameters, "termination_grace_period_seconds", null)

        dynamic "tolerations" {
          for_each = lookup(local.k8s_apps_v1_stateful_set_parameters, "tolerations", [])
          content {
        ...
        dynamic "topology_spread_constraints" {
          for_each = lookup(local.k8s_apps_v1_stateful_set_parameters, "topology_spread_constraints", [])
          content {
            dynamic "label_selector" {
        ...
        dynamic "volumes" {
          for_each = lookup(local.k8s_apps_v1_stateful_set_parameters, "volumes", [])
          content {
    ...
    dynamic "update_strategy" {
      for_each = lookup(local.k8s_apps_v1_stateful_set_parameters, "update_strategy", null) == null ? [] : [local.k8s_apps_v1_stateful_set_parameters.update_strategy]
      content {
    ...
    dynamic "volume_claim_templates" {
      for_each = lookup(local.k8s_apps_v1_stateful_set_parameters, "volume_claim_templates", [])
      content {
        api_version = lookup(volume_claim_templates.value, "api_version", null)
        kind        = lookup(volume_claim_templates.value, "kind", null)
        ...
        spec {
          ...
          dynamic "resources" {
            for_each = lookup(volume_claim_templates.value, "resources", null) == null ? [] : [volume_claim_templates.value.resources]
            content {
              limits   = lookup(resources.value, "limits", null)
              requests = lookup(resources.value, "requests", null)
            }
          ...
          dynamic "selector" {
            for_each = lookup(volume_claim_templates.value, "selector", null) == null ? [] : [volume_claim_templates.value.selector]
            content {
              dynamic "match_expressions" {
                for_each = lookup(selector.value, "match_expressions", [])
                content {
          ...
          storage_class_name = lookup(volume_claim_templates.value, "storage_class_name", null)
          volume_mode        = lookup(volume_claim_templates.value, "volume_mode", null)
          volume_name        = lookup(volume_claim_templates.value, "volume_name", null)
        }
      }
    }
  }
