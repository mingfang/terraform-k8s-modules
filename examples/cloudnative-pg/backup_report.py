...
Environment variables (set by terraform null_resource):
  NAMESPACE - Kubernetes namespace (default: cloudnative-pg-example)
  CLUSTER   - CloudNativePG cluster name (default: cloudnative-pg)

Standalone usage:
  NAMESPACE=cloudnative-pg-example CLUSTER=cloudnative-pg python3 backup_report.py
"""
...
# Defaults
NAMESPACE = os.environ.get("NAMESPACE", "cloudnative-pg-example")
CLUSTER = os.environ.get("CLUSTER", "cloudnative-pg")
