resource "k8s_core_v1_config_map" "che" {
  data = {
    "CHE_API"                                                  = "http://che-default.${var.CHE_INFRA_KUBERNETES_INGRESS_DOMAIN}/api"
    "CHE_CORS_ALLOWED__ORIGINS"                                = "*"
    "CHE_CORS_ALLOW__CREDENTIALS"                              = "false"
    "CHE_CORS_ENABLED"                                         = "true"
    "CHE_DEBUG_SERVER"                                         = "true"
    "CHE_HOST"                                                 = "che-default.${var.CHE_INFRA_KUBERNETES_INGRESS_DOMAIN}"
    "CHE_INFRASTRUCTURE_ACTIVE"                                = "kubernetes"
    "CHE_INFRA_KUBERNETES_BOOTSTRAPPER_BINARY__URL"            = "http://che-default.${var.CHE_INFRA_KUBERNETES_INGRESS_DOMAIN}/agent-binaries/linux_amd64/bootstrapper/bootstrapper"
    ...
    "CHE_INFRA_KUBERNETES_NAMESPACE"                           = "workspace"
    "CHE_INFRA_KUBERNETES_SERVICE__ACCOUNT__NAME"              = "workspace"
    ...
    "CHE_WEBSOCKET_ENDPOINT"                                   = "ws://che-default.${var.CHE_INFRA_KUBERNETES_INGRESS_DOMAIN}/api/websocket"
    "CHE_WEBSOCKET_ENDPOINT__MINOR"                            = "ws://che-default.${var.CHE_INFRA_KUBERNETES_INGRESS_DOMAIN}/api/websocket-minor"
