resource "k8s_apiextensions_k8s_io_v1_custom_resource_definition" "verticalpodautoscalers_autoscaling_k8s_io" {
  metadata {
    annotations = {
  ...
  spec {
    ...
    names {
      ...
      list_kind = "VerticalPodAutoscalerList"
    ...
    versions {
      ...
      additional_printer_columns {
        json_path = ".spec.updatePolicy.updateMode"
        name      = "Mode"
        type      = "string"
      }
      additional_printer_columns {
        json_path = ".status.recommendation.containerRecommendations[0].target.cpu"
        name      = "CPU"
        type      = "string"
      }
      additional_printer_columns {
        json_path = ".status.recommendation.containerRecommendations[0].target.memory"
        name      = "Mem"
        type      = "string"
      }
      additional_printer_columns {
        json_path = ".status.conditions[?(@.type=='RecommendationProvided')].status"
        name      = "Provided"
        type      = "string"
      }
      additional_printer_columns {
